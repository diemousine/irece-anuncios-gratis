<?php
// FORMULÁRIO DE CADASTRO DE ELETRÔNICO
$con = bdcon();
$vars = new _model;
echo("
<div class='row blackboard'>
	<div class='col-md-8 col-md-offset-2'>
		<form class='form-horizontal' id='form-cadastro' method='POST' action='$eletronico_path/' enctype='multipart/form-data'>
			<div class='panel panel-default'>
				<div class='panel-heading'>FORMULÁRIO DE CADASTRO DE NOVOS ELETRÔNICOS</div>
				<div class='panel-body'>
					...
					<div class='form-group'>
						...
						<div class='col-md-5'>
							<input type='text' class='form-control' id='inputTipo' name='produto' maxlength='45' placeholder='Ex.: SMARTPHONE MOTO G' required>
						</div>
					</div>
					<div class='form-group'>
				...
				<div class='panel-body'>
					...
					<div class='form-group'>
						...
						<div class='col-md-2'>
							<a class='btn btn-default' href='$home_eletronico_path'>Cancelar</a>
						</div>
					</div>
				</div>				
			</div>
