<?php
// EXIBE A PÁGINA PRINCIPAL DE VISUALIAÇÃO DE SERVIÇOS
echo("<div class='row blackboard'>
		<div class='col-md-10 col-md-offset-1' id='divdisplay'>
		<div class='page-header'><h1>Serviços <small>quem faz o que?</small></h1></div>");
if(($publicacoes = _model::publicacoes($dados, 0)) != "") echo($publicacoes."</div>
	</div>
	<div class='row blackboard' id='divbuscarmais'>
		<div class='col-md-10 col-md-offset-1'>
				<input type='button' class='btn btn-info center-block' id='btn-busca-mais' value='Ver se tem mais serviços' />
				<br />
		</div>
	</div>");
				...
				<div class='col-md-4 col-md-offset-4'>
					<p><img src='$home_path/img/servicos.png' title='servicos' /></p>
